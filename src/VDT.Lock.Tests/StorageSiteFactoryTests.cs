...
public class StorageSiteFactoryTests {
    ...
    public void DeserializeFromFileSystemStorageSite() {
        ...
        using var result = subject.DeserializeFrom([21, 0, 0, 0, 70, 105, 108, 101, 83, 121, 115, 116, 101, 109, 83, 116, 111, 114, 97, 103, 101, 83, 105, 116, 101, 15, 0, 0, 0, 3, 0, 0, 0, 98, 97, 114, 4, 0, 0, 0, 1, 2, 3, 4]);
